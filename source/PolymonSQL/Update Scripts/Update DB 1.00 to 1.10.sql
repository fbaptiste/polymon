 ...
 /****** Object:  Table [dbo].[MonitorActionTriggerType]    Script Date: 05/08/2008 17:54:48 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[ScriptEngine]    Script Date: 05/08/2008 17:54:49 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[MonitorAction]    Script Date: 05/08/2008 17:54:45 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  ForeignKey [FK_MonitorAction_Monitor]    Script Date: 05/08/2008 17:54:46 ******/
...
GO
/****** Object:  ForeignKey [FK_MonitorAction_MonitorActionTriggerType]    Script Date: 05/08/2008 17:54:46 ******/
...
GO
/****** Object:  ForeignKey [FK_MonitorAction_ScriptEngine]    Script Date: 05/08/2008 17:54:46 ******/
...
GO
 ...
 /***************** MonitorCurrentStatus Schema *****************************/
 --Add two columns
alter table MonitorCurrentStatus
add StatusStartDT datetime NULL
GO

alter table MonitorCurrentStatus
add StatusEndDT datetime NULL
GO

alter table MonitorCurrentStatus
add TimeElapsedSecs int NULL
GO

alter table MonitorCurrentStatus
add TimeElapsedTxt varchar(1000)
GO

 /***************** Operator Schema *****************************/
alter table Operator
add QueuedNotify tinyint NOT NULL
default 1 with values
GO

alter table Operator
add SummaryNotify bit NOT NULL
default 0 with values
GO

alter table Operator
add SummaryNotifyOK bit NOT NULL
default 0 with values
GO

alter table Operator
add SummaryNotifyWarn bit NOT NULL
default 1 with values
GO

alter table Operator
add SummaryNotifyFail bit NOT NULL
default 1 with values
GO

alter table Operator
add SummaryNotifyTime char(5) NOT NULL
default '08:00' with values
GO

alter table Operator
add SummaryNextNotifyDT datetime NOT NULL
default getdate() with values
GO


 /***************** Operator Alert Schema *****************************/
alter table OperatorAlert
add IsQueued bit NOT NULL
default 0 with values
GO

/****** Object:  Index [IX_OperatorAlert_IsQueued]    Script Date: 05/01/2008 14:09:07 ******/
...
/***************** Monitor Event Indexes *****************************/
/****** Object:  Index [IX_MonitorEvent]    Script Date: 05/13/2008 08:10:31 ******/
/***************** Monitor Event Indexes *****************************/
/****** Object:  Index [IX_MonitorEvent]    Script Date: 05/13/2008 08:10:31 ******/
IF NOT EXISTS (SELECT * FROM sys.indexes WHERE object_id = OBJECT_ID(N'[dbo].[MonitorEvent]') AND name = N'IX_MonitorEvent')
...
/****** Object:  Trigger [trgOperatorAlert_Insert]    Script Date: 05/08/2008 18:12:52 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  Trigger [UpDownTimeCalculation]    Script Date: 05/08/2008 18:12:52 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Object:  StoredProcedure [dbo].[polymon_sel_MonitorMetadata]    Script Date: 05/08/2008 18:07:08 ******/
DROP PROCEDURE [dbo].[polymon_sel_MonitorMetadata]
GO
/****** Object:  StoredProcedure [dbo].[polymon_ins_MonitorEvent]    Script Date: 05/08/2008 18:07:00 ******/
DROP PROCEDURE [dbo].[polymon_ins_MonitorEvent]
GO
/****** Object:  StoredProcedure [dbo].[polymon_ins_MonitorEventCounter]    Script Date: 05/08/2008 18:07:01 ******/
DROP PROCEDURE [dbo].[polymon_ins_MonitorEventCounter]
GO
/****** Object:  StoredProcedure [dbo].[polymon_sel_MonitorList]    Script Date: 05/08/2008 18:07:08 ******/
DROP PROCEDURE [dbo].[polymon_sel_MonitorList]
GO
/****** Object:  StoredProcedure [dbo].[polymon_sel_PendingEmailAlerts]    Script Date: 05/08/2008 18:07:11 ******/
DROP PROCEDURE [dbo].[polymon_sel_PendingEmailAlerts]
GO
/****** Object:  StoredProcedure [dbo].[polymon_hyb_MarkEmailSent]    Script Date: 05/08/2008 18:06:51 ******/
DROP PROCEDURE [dbo].[polymon_hyb_MarkEmailSent]
GO
/****** Object:  StoredProcedure [dbo].[polymon_sel_MonitorOperators]    Script Date: 05/08/2008 18:07:09 ******/
DROP PROCEDURE [dbo].[polymon_sel_MonitorOperators]
GO
/****** Object:  StoredProcedure [dbo].[polymon_sel_Operator]    Script Date: 05/08/2008 18:07:10 ******/
DROP PROCEDURE [dbo].[polymon_sel_Operator]
GO
/****** Object:  StoredProcedure [dbo].[polymon_hyb_SaveOperator]    Script Date: 05/08/2008 18:06:56 ******/
DROP PROCEDURE [dbo].[polymon_hyb_SaveOperator]
GO
/****** Object:  StoredProcedure [dbo].[polymon_del_DeleteOperator]    Script Date: 05/08/2008 18:06:50 ******/
DROP PROCEDURE [dbo].[polymon_del_DeleteOperator]
GO
/****** Object:  StoredProcedure [dbo].[polymon_ins_AssignMonitorOperator]    Script Date: 05/08/2008 18:06:58 ******/
DROP PROCEDURE [dbo].[polymon_ins_AssignMonitorOperator]
GO
/****** Object:  StoredProcedure [dbo].[polymon_del_RemoveMonitorOperator]    Script Date: 05/08/2008 18:06:51 ******/
DROP PROCEDURE [dbo].[polymon_del_RemoveMonitorOperator]
GO
/****** Object:  StoredProcedure [dbo].[polymon_sel_MonitorMetadataCurrentDT]    Script Date: 05/08/2008 18:07:09 ******/
DROP PROCEDURE [dbo].[polymon_sel_MonitorMetadataCurrentDT]
GO
/****** Object:  StoredProcedure [dbo].[polymon_hyb_SaveMonitorMetadata]    Script Date: 05/08/2008 18:06:55 ******/
DROP PROCEDURE [dbo].[polymon_hyb_SaveMonitorMetadata]
GO
/****** Object:  StoredProcedure [dbo].[polymon_del_DeleteMonitor]    Script Date: 05/08/2008 18:06:49 ******/
DROP PROCEDURE [dbo].[polymon_del_DeleteMonitor]
GO
/****** Object:  StoredProcedure [dbo].[polymon_sel_Operators]    Script Date: 05/08/2008 18:07:11 ******/
DROP PROCEDURE [dbo].[polymon_sel_Operators]
GO
/****** Object:  StoredProcedure [dbo].[polymon_sel_MonitorTypeMetadata]    Script Date: 05/08/2008 18:07:10 ******/
DROP PROCEDURE [dbo].[polymon_sel_MonitorTypeMetadata]
GO
/****** Object:  StoredProcedure [dbo].[polymon_sel_MonitorTypes]    Script Date: 05/08/2008 18:07:10 ******/
DROP PROCEDURE [dbo].[polymon_sel_MonitorTypes]
GO
/****** Object:  StoredProcedure [dbo].[polymon_hyb_SaveMonitorType]    Script Date: 05/08/2008 18:06:55 ******/
DROP PROCEDURE [dbo].[polymon_hyb_SaveMonitorType]
GO
/****** Object:  StoredProcedure [dbo].[polymon_del_DeleteMonitorType]    Script Date: 05/08/2008 18:06:49 ******/
DROP PROCEDURE [dbo].[polymon_del_DeleteMonitorType]
GO
/****** Object:  StoredProcedure [dbo].[agg_RebuildAggStatus]    Script Date: 05/08/2008 18:06:46 ******/
DROP PROCEDURE [dbo].[agg_RebuildAggStatus]
GO
/****** Object:  StoredProcedure [dbo].[polymon_sel_MonitorType]    Script Date: 05/08/2008 18:07:09 ******/
DROP PROCEDURE [dbo].[polymon_sel_MonitorType]
GO
/****** Object:  StoredProcedure [dbo].[agg_RebuildAggCounter]    Script Date: 05/08/2008 18:06:45 ******/
DROP PROCEDURE [dbo].[agg_RebuildAggCounter]
GO
/****** Object:  StoredProcedure [dbo].[polymon_ins_EvaluateEventAlertStatus]    Script Date: 05/08/2008 18:06:59 ******/
DROP PROCEDURE [dbo].[polymon_ins_EvaluateEventAlertStatus]
GO
/****** Object:  StoredProcedure [dbo].[agg_Monitor_ApplyRetentionScheme]    Script Date: 05/08/2008 18:06:45 ******/
DROP PROCEDURE [dbo].[agg_Monitor_ApplyRetentionScheme]
GO
/****** Object:  StoredProcedure [dbo].[polymon_sel_DashboardGroups]    Script Date: 05/08/2008 18:07:02 ******/
DROP PROCEDURE [dbo].[polymon_sel_DashboardGroups]
GO
/****** Object:  StoredProcedure [dbo].[executive_MonitorMetadataLatestUpdateDT]    Script Date: 05/08/2008 18:06:48 ******/
DROP PROCEDURE [dbo].[executive_MonitorMetadataLatestUpdateDT]
GO
/****** Object:  StoredProcedure [dbo].[polymon_hyb_SetExecutiveService]    Script Date: 05/08/2008 18:06:58 ******/
DROP PROCEDURE [dbo].[polymon_hyb_SetExecutiveService]
GO
/****** Object:  StoredProcedure [dbo].[polymon_sel_DashboardGroupPanels]    Script Date: 05/08/2008 18:07:02 ******/
DROP PROCEDURE [dbo].[polymon_sel_DashboardGroupPanels]
GO
/****** Object:  StoredProcedure [dbo].[polymon_del_MonitorData]    Script Date: 05/08/2008 18:06:50 ******/
DROP PROCEDURE [dbo].[polymon_del_MonitorData]
GO
/****** Object:  StoredProcedure [dbo].[polymon_del_DeleteDashboardGroup]    Script Date: 05/08/2008 18:06:48 ******/
DROP PROCEDURE [dbo].[polymon_del_DeleteDashboardGroup]
GO
/****** Object:  StoredProcedure [dbo].[polymon_hyb_SaveDashboardGroup]    Script Date: 05/08/2008 18:06:52 ******/
DROP PROCEDURE [dbo].[polymon_hyb_SaveDashboardGroup]
GO
/****** Object:  StoredProcedure [dbo].[polymon_hyb_SaveDashboardPanel]    Script Date: 05/08/2008 18:06:52 ******/
DROP PROCEDURE [dbo].[polymon_hyb_SaveDashboardPanel]
GO
/****** Object:  StoredProcedure [dbo].[polymon_del_DeleteDashboardPanel]    Script Date: 05/08/2008 18:06:48 ******/
DROP PROCEDURE [dbo].[polymon_del_DeleteDashboardPanel]
GO
/****** Object:  StoredProcedure [dbo].[polymon_sel_DashboardGroup]    Script Date: 05/08/2008 18:07:01 ******/
DROP PROCEDURE [dbo].[polymon_sel_DashboardGroup]
GO
/****** Object:  StoredProcedure [dbo].[polymon_ins_DashBoardPanel]    Script Date: 05/08/2008 18:06:59 ******/
DROP PROCEDURE [dbo].[polymon_ins_DashBoardPanel]
GO
/****** Object:  StoredProcedure [dbo].[polymon_sel_DashboardPanel]    Script Date: 05/08/2008 18:07:03 ******/
DROP PROCEDURE [dbo].[polymon_sel_DashboardPanel]
GO
/****** Object:  StoredProcedure [dbo].[polymon_sel_LastMonitorStatus]    Script Date: 05/08/2008 18:07:07 ******/
DROP PROCEDURE [dbo].[polymon_sel_LastMonitorStatus]
GO
/****** Object:  StoredProcedure [dbo].[polymon_sel_NonNominalMonitors]    Script Date: 05/08/2008 18:07:10 ******/
DROP PROCEDURE [dbo].[polymon_sel_NonNominalMonitors]
GO
/****** Object:  StoredProcedure [dbo].[polymon_sel_HistMonitorEvents_NDays]    Script Date: 05/08/2008 18:07:06 ******/
DROP PROCEDURE [dbo].[polymon_sel_HistMonitorEvents_NDays]
GO
/****** Object:  StoredProcedure [dbo].[polymon_sel_HistMonitorEvents_FreqDist]    Script Date: 05/08/2008 18:07:06 ******/
DROP PROCEDURE [dbo].[polymon_sel_HistMonitorEvents_FreqDist]
GO
/****** Object:  StoredProcedure [dbo].[polymon_sel_HistMonitorCounter_NDays]    Script Date: 05/08/2008 18:07:04 ******/
DROP PROCEDURE [dbo].[polymon_sel_HistMonitorCounter_NDays]
GO
/****** Object:  StoredProcedure [dbo].[polymon_sel_HistMonitorCounters_NDays]    Script Date: 05/08/2008 18:07:05 ******/
DROP PROCEDURE [dbo].[polymon_sel_HistMonitorCounters_NDays]
GO
/****** Object:  StoredProcedure [dbo].[polymon_sel_HistMonitorCounters_Averages]    Script Date: 05/08/2008 18:07:05 ******/
DROP PROCEDURE [dbo].[polymon_sel_HistMonitorCounters_Averages]
GO
/****** Object:  StoredProcedure [dbo].[polymon_sel_DashboardGroupAvailableMonitors]    Script Date: 05/08/2008 18:07:02 ******/
DROP PROCEDURE [dbo].[polymon_sel_DashboardGroupAvailableMonitors]
GO
/****** Object:  StoredProcedure [dbo].[rpt_StatusData_CustomFreq]    Script Date: 05/08/2008 18:07:16 ******/
DROP PROCEDURE [dbo].[rpt_StatusData_CustomFreq]
GO
/****** Object:  StoredProcedure [dbo].[polymon_sel_EventHistory]    Script Date: 05/08/2008 18:07:04 ******/
DROP PROCEDURE [dbo].[polymon_sel_EventHistory]
GO
/****** Object:  StoredProcedure [dbo].[polymon_sel_SysSettings]    Script Date: 05/08/2008 18:07:12 ******/
DROP PROCEDURE [dbo].[polymon_sel_SysSettings]
GO
/****** Object:  StoredProcedure [dbo].[rpt_GetStatusDateRanges]    Script Date: 05/08/2008 18:07:16 ******/
DROP PROCEDURE [dbo].[rpt_GetStatusDateRanges]
GO
/****** Object:  StoredProcedure [dbo].[polymon_hyb_SaveSysSettings]    Script Date: 05/08/2008 18:06:57 ******/
DROP PROCEDURE [dbo].[polymon_hyb_SaveSysSettings]
GO
/****** Object:  StoredProcedure [dbo].[rpt_CounterData_Daily]    Script Date: 05/08/2008 18:07:13 ******/
DROP PROCEDURE [dbo].[rpt_CounterData_Daily]
GO
/****** Object:  UserDefinedFunction [dbo].[fn_MonitorCurrentStatusID]    Script Date: 05/08/2008 18:07:21 ******/
DROP FUNCTION [dbo].[fn_MonitorCurrentStatusID]
GO
/****** Object:  StoredProcedure [dbo].[rpt_StatusData_Daily]    Script Date: 05/08/2008 18:07:17 ******/
DROP PROCEDURE [dbo].[rpt_StatusData_Daily]
GO
/****** Object:  StoredProcedure [dbo].[rpt_CounterData_Monthly]    Script Date: 05/08/2008 18:07:14 ******/
DROP PROCEDURE [dbo].[rpt_CounterData_Monthly]
GO
/****** Object:  StoredProcedure [dbo].[rpt_StatusData_Monthly]    Script Date: 05/08/2008 18:07:18 ******/
DROP PROCEDURE [dbo].[rpt_StatusData_Monthly]
GO
/****** Object:  StoredProcedure [dbo].[rpt_CounterData_Weekly]    Script Date: 05/08/2008 18:07:15 ******/
DROP PROCEDURE [dbo].[rpt_CounterData_Weekly]
GO
/****** Object:  StoredProcedure [dbo].[rpt_StatusData_Weekly]    Script Date: 05/08/2008 18:07:19 ******/
DROP PROCEDURE [dbo].[rpt_StatusData_Weekly]
GO
/****** Object:  StoredProcedure [dbo].[rpt_CurrentStatus]    Script Date: 05/08/2008 18:07:15 ******/
DROP PROCEDURE [dbo].[rpt_CurrentStatus]
GO
/****** Object:  StoredProcedure [dbo].[rpt_StatusSummary_Raw]    Script Date: 05/08/2008 18:07:19 ******/
DROP PROCEDURE [dbo].[rpt_StatusSummary_Raw]
GO
/****** Object:  StoredProcedure [dbo].[rpt_CounterData_CustomAverage]    Script Date: 05/08/2008 18:07:13 ******/
DROP PROCEDURE [dbo].[rpt_CounterData_CustomAverage]
GO
/****** Object:  StoredProcedure [dbo].[polymon_sel_PercUptimeAnalysis]    Script Date: 05/08/2008 18:07:11 ******/
DROP PROCEDURE [dbo].[polymon_sel_PercUptimeAnalysis]
GO
/****** Object:  StoredProcedure [dbo].[rpt_CounterData_Raw]    Script Date: 05/08/2008 18:07:14 ******/
DROP PROCEDURE [dbo].[rpt_CounterData_Raw]
GO
/****** Object:  StoredProcedure [dbo].[rpt_StatusData_Raw]    Script Date: 05/08/2008 18:07:18 ******/
DROP PROCEDURE [dbo].[rpt_StatusData_Raw]
GO
/****** Object:  StoredProcedure [dbo].[polymon_sel_AllCurrentStatus]    Script Date: 05/08/2008 18:07:01 ******/
DROP PROCEDURE [dbo].[polymon_sel_AllCurrentStatus]
GO
/****** Object:  StoredProcedure [dbo].[polymon_hyb_SaveDefaultRetentionSettings]    Script Date: 05/08/2008 18:06:53 ******/
DROP PROCEDURE [dbo].[polymon_hyb_SaveDefaultRetentionSettings]
GO
/****** Object:  StoredProcedure [dbo].[polymon_ins_GenerateAlert]    Script Date: 05/08/2008 18:06:59 ******/
DROP PROCEDURE [dbo].[polymon_ins_GenerateAlert]
GO
/****** Object:  StoredProcedure [dbo].[agg_UpdateCounterTables]    Script Date: 05/08/2008 18:06:46 ******/
DROP PROCEDURE [dbo].[agg_UpdateCounterTables]
GO
/****** Object:  StoredProcedure [dbo].[agg_ApplyRetentionScheme]    Script Date: 05/08/2008 18:06:44 ******/
DROP PROCEDURE [dbo].[agg_ApplyRetentionScheme]
GO
/****** Object:  UserDefinedFunction [dbo].[fn_PercUptime]    Script Date: 05/08/2008 18:07:21 ******/
DROP FUNCTION [dbo].[fn_PercUptime]
GO
/****** Object:  UserDefinedFunction [dbo].[fn_MonitorCurrentStatus]    Script Date: 05/08/2008 18:07:21 ******/
DROP FUNCTION [dbo].[fn_MonitorCurrentStatus]
GO
/****** Object:  StoredProcedure [dbo].[agg_UpdateStatusTables]    Script Date: 05/08/2008 18:06:47 ******/
DROP PROCEDURE [dbo].[agg_UpdateStatusTables]
GO
/****** Object:  UserDefinedFunction [dbo].[fn_PrevEventDT]    Script Date: 05/08/2008 18:07:20 ******/
DROP FUNCTION [dbo].[fn_PrevEventDT]
GO
/****** Object:  UserDefinedFunction [dbo].[fn_IsOfflineTime]    Script Date: 05/08/2008 18:07:21 ******/
...
END
GO
/****** Object:  StoredProcedure [dbo].[polymon_sel_SummaryNotificationReadyOperators]    Script Date: 05/08/2008 18:07:12 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[polymon_hyb_OperatorSummaryNotificationSent]    Script Date: 05/08/2008 18:06:51 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[polymon_sel_RecapEmailAlerts]    Script Date: 05/08/2008 18:07:12 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[polymon_sel_OperatorCurrentMonitorStatus]    Script Date: 05/08/2008 18:07:10 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  UserDefinedFunction [dbo].[fn_tbl_CurrentStatusStats]    Script Date: 05/08/2008 18:07:19 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  UserDefinedFunction [dbo].[fn_CurrentStatusStatsXML]    Script Date: 05/08/2008 18:07:22 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[polymon_sel_QueuedEmailAlerts]    Script Date: 05/08/2008 18:07:11 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[polymon_hyb_SetQueuedAlertsSent]    Script Date: 05/08/2008 18:06:58 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  StoredProcedure [dbo].[polymon_hyb_SaveMonitorActionScript]    Script Date: 05/08/2008 18:06:54 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END
GO
/****** Object:  StoredProcedure [dbo].[polymon_sel_MonitorActionScripts]    Script Date: 05/08/2008 18:07:07 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
 ...
 /*******************************************************************************/
GO
--Calculate Status stats for every monitor and update MonitorCurrentStatus
declare @MonitorID int

declare MonitorID_cursor CURSOR FOR
select MonitorID from Monitor

open MonitorID_cursor

fetch next from MonitorID_cursor into @MonitorID

while @@FETCH_STATUS=0
	begin
	if exists(select * from MonitorCurrentStatus where MonitorID=@MonitorID)
		begin
		--Update MonitorCurrentStatus with status stats
		update MonitorCurrentStatus
		set MonitorCurrentStatus.StatusStartDT=S.StatusStartDT,
			MonitorCurrentStatus.StatusEndDT=S.StatusEndDT,
			MonitorCurrentStatus.TimeElapsedSecs=S.TimeElapsedSecs,
			MonitorCurrentStatus.TimeElapsedTxt=S.TimeElapsedTxt
		from dbo.fn_tbl_CurrentStatusStats(@MonitorID) S
		where MonitorCurrentStatus.MonitorID=@MonitorID
		end
	fetch next from MonitorID_cursor into @MonitorID
...
close MonitorID_cursor
deallocate MonitorID_cursor
GO
