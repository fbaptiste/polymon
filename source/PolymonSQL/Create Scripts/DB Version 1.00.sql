...
Declare @SQL varchar(8000)
	...
	set @SQL = @SQL + ' and TS.DT between ''' + convert(varchar(10), @StartDT, 120) + ' 00:00:00' + ''' '
	set @SQL = @SQL + ' and ''' + convert(varchar(10), @EndDT, 120) + ' 23:59:59' + ''' '
...
Declare @StartDT datetime
Declare @EndDT datetime
set @StartDT = cast('2006-01-01 00:00:00' as datetime)
